...
#### 执行命令：
```
apk update && wget https://raw.githubusercontent.com/getongoing/32m/main/xr_install.sh -O xr_install.sh && ash xr_install.sh
```
#### 完全删除命令：
...
```
apk update && wget https://raw.githubusercontent.com/getongoing/32m/main/apline_vm_ws_tls.sh -O apline_vm_ws_tls.sh && ash apline_vm_ws_tls.sh
```
